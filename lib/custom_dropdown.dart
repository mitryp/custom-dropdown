...
class CustomDropdown<T> extends StatefulWidget {
  ...
  /// The header builder that will be used to build the overlay header field, if not null.
  /// Otherwise, the default behavior will be preserved.
  final _HeaderBuilder<T>? expandedHeaderBuilder;
            ...
            child: _OverlayBuilder(
              ...
              overlay: (size, hideCallback) {
                return _DropdownOverlay<T>(
                  ...
                  headerBuilder: widget.expandedHeaderBuilder ?? widget.headerBuilder,
